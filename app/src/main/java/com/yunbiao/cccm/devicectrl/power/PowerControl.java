...
import com.yunbiao.cccm.cache.FileCache;
...
public class PowerControl {
    private static PowerControl instance;
    public final static String POWER_ON = "poerOn";
    public final static String POWER_OFF = "poerOff";

    public synchronized static PowerControl getInstance(){
        if(instance == null){
            instance = new PowerControl();
        }
        return instance;
    }
