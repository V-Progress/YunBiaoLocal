...
public class Daily {
    ...
    @ToMany(referencedJoinProperty = "parentDate")
    ...
    @Generated(hash = 885892416)
    public Daily(Long id, String date) {
        this.id = id;
        this.date = date;
    }
    ...
    public List<TimeSlot> getTimeSlots() {
        if (timeSlots == null) {
            ...
            List<TimeSlot> timeSlotsNew = targetDao._queryDaily_TimeSlots(date);
            synchronized (this) {
                if (timeSlots == null) {
