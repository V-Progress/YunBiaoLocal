...
import com.yunbiao.cccm.net.bean.ChannelBean;
import com.yunbiao.cccm.net.bean.DiskInfoBean;
import com.yunbiao.cccm.net.bean.LoginModel;
import com.yunbiao.cccm.net.bean.PowerCtrlBean;
import com.yunbiao.cccm.net.bean.SerNumBean;
import com.yunbiao.cccm.net.bean.VoiceModel;
